...
function numberOfCharacters(string) {
  //La función recibe un string. Recorre el srting y devuelve 
  // el caracter con el número de veces que aparece 
...
function asAmirror(str) {
  ...
  //pero con cada una de sus palabras invertidas, 
...
function capicua(numero){
  //Escribe una función, la cual recibe un número 
  //y determina si es o no capicúa.
  //La misma debe retornar: "Es capicua" si el número 
  //se número que se lee igual de 
  //izquierda a derecha que de derecha a izquierda. 
  //Caso contrario retorna "No es capicua"
  //Escribe tu código aquí
...
function deleteAbc(cadena){
  //Define una función que elimine las letras 
  //"a", "b" y "c" de la cadena dada 
  //y devuelva la versión modificada o la misma 
  //cadena, en caso de contener dichas letras.
  //Escribe tu código aquí
...
function sortArray(arr) {
  ...
  //Ordena la matriz en orden creciente de 
  //longitudes de cadena
  //Ej: Recibe ---> ["You", "are", "beautiful", 
  //"looking"] || Devuelve ---> 
...
function buscoInterseccion(arreglo1, arreglo2){
  ...
  //retornar un nuevo array con la intersección de 
  //ambos elementos. (Ej: [4,2,3] unión [1,3,4] = [3,4].
  //Si no tienen elementos en común, 
  //retornar un arreglo vacío.
  //Aclaración: los arreglos no necesariamente 
